...
class MainActivity : AppCompatActivity() {
  ...
  private var japaneseCharacterClassifier = JapaneseCharacterClassifier(this)
  ...
  override fun onDestroy() {
    ...
    japaneseCharacterClassifier.close()
    super.onDestroy()
  }
  ...
  private fun classifyDrawing() {
    ...
    if ((bitmap != null) && (japaneseCharacterClassifier.isInitialized)) {
      japaneseCharacterClassifier
